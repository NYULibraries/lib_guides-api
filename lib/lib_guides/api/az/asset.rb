module LibGuides
  module API
    module Az
      class Asset < Base
        MUTABLE_ATTRIBUTES = %i[name description url site_id type_id owner_id az_vendor_id meta created updated slug_id enable_hidden az_types enable_new enable_trial enable_popular internal_note library_review alt_names]
